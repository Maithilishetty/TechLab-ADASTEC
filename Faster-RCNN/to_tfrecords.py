...
import tqdm
import sys
sys.path.insert(0, os.path.abspath("/home/mcity/bstld")) 
...
def label_id(label_string):
    ...
    y = constants.TF_ID_MAP[constants.SIMPLIFIED_CLASSES[label_string]]
    return y


def modified_label_string(label_string):
    """ To simplify the problem, training classes are grouped by color """
    x = constants.SIMPLIFIED_CLASSES[label_string].encode('utf8')
    return x
